...
FFA_WAPPALYZER_NME="Wappalyzer"                                                                               # Firefox Add-on: 'Wappalyzer' Name
FFA_WAPPALYZER_URL="https://addons.mozilla.org/en-US/firefox/addon/wappalyzer/"                               # Firefox Add-on: 'Wappalyzer' URL
