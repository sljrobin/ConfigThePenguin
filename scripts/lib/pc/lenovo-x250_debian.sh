...
function lenovox250_debian_audio()
{
  ...
  colorize "Lenovo ThinkPad X250 Audio drivers [1/${STP_D_DRV_X250_AUDIO}] Changing the audio card's order" $CLR_LBLUE "y"
...
function lenovox250_debian_wifi()
{
  ...
  colorize "Lenovo ThinkPad X250 WiFi drivers [1/${STP_D_DRV_X250_WIFI}] Installing drivers" $CLR_LBLUE "y"
  aptitude install firmware-iwlwifi
  colorize "Lenovo ThinkPad X250 WiFi drivers [2/${STP_D_DRV_X250_WIFI}] Removing module from the kernel" $CLR_LBLUE "y"
  modprobe -r iwlwifi
  colorize "Lenovo ThinkPad X250 Wifi drivers [3/${STP_D_DRV_X250_WIFI}] Executing module" $CLR_LBLUE "y"
  modprobe iwlwifi
...
function lenovox250_debian_wifiadapter()
{
  ...
  colorize "Lenovo ThinkPad X250 WiFi Adapter drivers [1/${STP_D_DRV_X250_WIFIADAPTER}] Installing drivers" $CLR_LBLUE "y"
